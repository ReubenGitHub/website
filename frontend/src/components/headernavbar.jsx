        ...
        <div className="navbar-container">
            ...
            <div className="nav-links">
                ...
                <div className="social-links">
                    ...
                    <a href="https://github.com/ReubenGitHub" target="_blank" aria-label="GitHub">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="https://www.linkedin.com/in/reuben-owen-williams-53609a173/" target="_blank" aria-label="LinkedIn">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
